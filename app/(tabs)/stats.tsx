...
const styles = StyleSheet.create({
	...
	timeText: { fontSize: 16, fontWeight: '700', letterSpacing: 0.2 },
	signalText: { fontSize: 11, fontWeight: '600', letterSpacing: 0.8 },
	pageTitle: { fontSize: 30, fontWeight: '700', marginBottom: 20, letterSpacing: -0.8 },
	...
	barFill: { width: '100%', borderRadius: 6, minHeight: 10 },
	barLabel: { marginTop: 8, fontSize: 10, letterSpacing: 0.8 },
	emptyText: { fontSize: 12 },
	featuredRow: { marginTop: -4, marginBottom: 16, paddingHorizontal: 4 },
	featuredText: { fontSize: 13, opacity: 0.9 },
	tabBar: {
		flexDirection: 'row',
		alignItems: 'center',
	...
	tabText: { fontSize: 10, letterSpacing: 1, textTransform: 'uppercase' },
